...
func mapCallLog(raw map[string]any) (CallLog, error) {
	...
	return CallLog{
		...
		InputTokens:  billableInputTokens(raw),
		OutputTokens: billableOutputTokens(raw),
		CostUnits:    costUnits,
...
func billableInputTokens(raw map[string]any) int64 {
	return int64Field(raw,
		[]string{"uncompressedInputTokens"},
		[]string{"uncompressed_input_tokens"},
		[]string{"uncompressedPromptTokens"},
		[]string{"uncompressed_prompt_tokens"},
		[]string{"uncompressedTokensIn"},
		[]string{"uncompressed_tokens_in"},
		[]string{"inputTokensUncompressed"},
		[]string{"input_tokens_uncompressed"},
		[]string{"promptTokensUncompressed"},
		[]string{"prompt_tokens_uncompressed"},
		[]string{"uncompressedTokens", "in"},
		[]string{"uncompressedTokens", "input"},
		[]string{"uncompressedTokens", "prompt"},
		[]string{"uncompressed_tokens", "in"},
		[]string{"uncompressed_tokens", "input"},
		[]string{"uncompressed_tokens", "prompt"},
		[]string{"tokensUncompressed", "in"},
		[]string{"tokensUncompressed", "input"},
		[]string{"tokensUncompressed", "prompt"},
		[]string{"tokens_uncompressed", "in"},
		[]string{"tokens_uncompressed", "input"},
		[]string{"tokens_uncompressed", "prompt"},
		[]string{"uncompressed", "in"},
		[]string{"uncompressed", "input"},
		[]string{"uncompressed", "prompt"},
		[]string{"tokens", "uncompressed", "in"},
		[]string{"tokens", "uncompressed", "input"},
		[]string{"tokens", "uncompressed", "prompt"},
		[]string{"tokens", "input", "uncompressed"},
		[]string{"tokens", "prompt", "uncompressed"},
		[]string{"usage", "uncompressedInputTokens"},
		[]string{"usage", "uncompressed_input_tokens"},
		[]string{"usage", "uncompressedPromptTokens"},
		[]string{"usage", "uncompressed_prompt_tokens"},
		[]string{"usage", "uncompressedTokens", "in"},
		[]string{"usage", "uncompressedTokens", "input"},
		[]string{"usage", "uncompressedTokens", "prompt"},
		[]string{"usage", "uncompressed_tokens", "in"},
		[]string{"usage", "uncompressed_tokens", "input"},
		[]string{"usage", "uncompressed_tokens", "prompt"},
		[]string{"usage", "tokensUncompressed", "in"},
		[]string{"usage", "tokensUncompressed", "input"},
		[]string{"usage", "tokensUncompressed", "prompt"},
		[]string{"usage", "tokens_uncompressed", "in"},
		[]string{"usage", "tokens_uncompressed", "input"},
		[]string{"usage", "tokens_uncompressed", "prompt"},
		[]string{"usage", "tokens", "uncompressed", "in"},
		[]string{"usage", "tokens", "uncompressed", "input"},
		[]string{"usage", "tokens", "uncompressed", "prompt"},
		[]string{"inputTokens"},
		[]string{"promptTokens"},
		[]string{"tokensIn"},
		[]string{"tokens_in"},
		...
		[]string{"usage", "tokensIn"},
		[]string{"usage", "tokens_in"},
		[]string{"usage", "tokens", "in"},
		[]string{"usage", "tokens", "input"},
	)
}

func billableOutputTokens(raw map[string]any) int64 {
	return int64Field(raw,
		[]string{"uncompressedOutputTokens"},
		[]string{"uncompressed_output_tokens"},
		[]string{"uncompressedCompletionTokens"},
		[]string{"uncompressed_completion_tokens"},
		[]string{"uncompressedTokensOut"},
		[]string{"uncompressed_tokens_out"},
		[]string{"outputTokensUncompressed"},
		[]string{"output_tokens_uncompressed"},
		[]string{"completionTokensUncompressed"},
		[]string{"completion_tokens_uncompressed"},
		[]string{"uncompressedTokens", "out"},
		[]string{"uncompressedTokens", "output"},
		[]string{"uncompressedTokens", "completion"},
		[]string{"uncompressed_tokens", "out"},
		[]string{"uncompressed_tokens", "output"},
		[]string{"uncompressed_tokens", "completion"},
		[]string{"tokensUncompressed", "out"},
		[]string{"tokensUncompressed", "output"},
		[]string{"tokensUncompressed", "completion"},
		[]string{"tokens_uncompressed", "out"},
		[]string{"tokens_uncompressed", "output"},
		[]string{"tokens_uncompressed", "completion"},
		[]string{"uncompressed", "out"},
		[]string{"uncompressed", "output"},
		[]string{"uncompressed", "completion"},
		[]string{"tokens", "uncompressed", "out"},
		[]string{"tokens", "uncompressed", "output"},
		[]string{"tokens", "uncompressed", "completion"},
		[]string{"tokens", "output", "uncompressed"},
		[]string{"tokens", "completion", "uncompressed"},
		[]string{"usage", "uncompressedOutputTokens"},
		[]string{"usage", "uncompressed_output_tokens"},
		[]string{"usage", "uncompressedCompletionTokens"},
		[]string{"usage", "uncompressed_completion_tokens"},
		[]string{"usage", "uncompressedTokens", "out"},
		[]string{"usage", "uncompressedTokens", "output"},
		[]string{"usage", "uncompressedTokens", "completion"},
		[]string{"usage", "uncompressed_tokens", "out"},
		[]string{"usage", "uncompressed_tokens", "output"},
		[]string{"usage", "uncompressed_tokens", "completion"},
		[]string{"usage", "tokensUncompressed", "out"},
		[]string{"usage", "tokensUncompressed", "output"},
		[]string{"usage", "tokensUncompressed", "completion"},
		[]string{"usage", "tokens_uncompressed", "out"},
		[]string{"usage", "tokens_uncompressed", "output"},
		[]string{"usage", "tokens_uncompressed", "completion"},
		[]string{"usage", "tokens", "uncompressed", "out"},
		[]string{"usage", "tokens", "uncompressed", "output"},
		[]string{"usage", "tokens", "uncompressed", "completion"},
		[]string{"outputTokens"},
		...
		[]string{"usage", "tokensOut"},
		[]string{"usage", "tokens_out"},
		[]string{"usage", "tokens", "out"},
		[]string{"usage", "tokens", "output"},
	)
}
